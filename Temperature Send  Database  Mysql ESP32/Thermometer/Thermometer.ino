...
void loop()
{
   ...
   temperature = (refvoltage * sensor * 100) / 1023; //converting degree to celcius
    ...
    if (request.indexOf("/Thermo=OFF") != -1)
    {
      ...
      client.println("<div class=relative>  <b> UNIVERSITY  </b> </div>");
      //client.println("<br>");
      ...
      HTTPClient http;
      String url = "http://192.168.43.210/iotproject/thermotry/add.php?temp="+String(temp); //access the php file to write data
      Serial.println(url);     
      http.begin(url);
